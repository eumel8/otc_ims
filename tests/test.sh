...
ansible-playbook test.yml -e "image_name=ansible-image01 image_url=ansible011:bionic-server-cloudimg-amd64.vmdk image_min_disk=4 localaction=create waitfor=true" || exit 1
